...
完整关键字介绍可查阅：[C++ 的关键字（保留字）完整介绍](https://www.nowcoder.com/tutorial/10003/4f26dfd7240a44f095f44ef9be963279)
...
|   int   |               对机器而言，整数的最自然的大小。               |
|  float  | 单精度浮点值。单精度是这样的格式，1位符号，8位指数，23位小数。![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569293142317_B54790B884D769399AD1BE741DB743B7) |
| double  | 双精度浮点值。双精度是1位符号，11位指数，52位小数。![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569293132950_DFFAFA273002E825B428C0E6453C6B6E) |
|  void   |                       表示类型的缺失。                       |
| wchar_t |                         宽字符类型。                         |
...
|   ++   | [自增运算符](https://www.nowcoder.com/tutorial/10003/576a29faa7f94201906623e477af0d7f)，整数值增加 1 |  A++ 将得到 11   |
|   --   | [自减运算符](https://www.nowcoder.com/tutorial/10003/576a29faa7f94201906623e477af0d7f)，整数值减少 1 |   A-- 将得到 9   |
...
|        运算符        |                             描述                             |
| :------------------: | :----------------------------------------------------------: |
|        sizeof        | [sizeof 运算符](https://www.nowcoder.com/tutorial/10003/0225712a99c64f4f9102284ae9f8f9b4)返回变量的大小。例如，sizeof(a) 将返回 4，其中 a 是整数。 |
|  Condition ? X : Y   | [条件运算符](https://www.nowcoder.com/tutorial/10003/6099239ff4b342d8b6186fc3937e7d7c)。如果 Condition 为真 ? 则值为 X : 否则值为 Y。 |
|          ,           | [逗号运算符](https://www.nowcoder.com/tutorial/10003/7d84a1d19b9241bb91f29400158fb324)会顺序执行一系列运算。整个逗号表达式的值是以逗号分隔的列表中的最后一个表达式的值。 |
| .（点）和 ->（箭头） | [成员运算符](https://www.nowcoder.com/tutorial/10003/61efa7acab174119983635ecc11a1463)用于引用类、结构和共用体的成员。 |
|         Cast         | [强制转换运算符](https://www.nowcoder.com/tutorial/10003/13c5d5f1a3234cbca9e2d7f057ffbda7)把一种数据类型转换为另一种数据类型。例如，int(2.2000) 将返回 2。 |
|          &           | [指针运算符 &](https://www.nowcoder.com/tutorial/10003/859f995daf88468786621c9a0affbbf6) 返回变量的地址。例如 &a; 将给出变量的实际地址。 |
|          *           | [指针运算符 *](https://www.nowcoder.com/tutorial/10003/859f995daf88468786621c9a0affbbf6) 指向一个变量。例如，*var; 将指向变量 var。 |
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569293379015_6466136D1077A4900F42C47E312D4188)
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569293421152_48B5E330CE1ABB26B5756AD0ADE1DD24)
...
|                           调用类型                           |                             描述                             |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| [传值调用](https://www.nowcoder.com/tutorial/10003/9ba9e100cdc047109b8abe73f5fb4b12) | 该方法把参数的实际值复制给函数的形式参数。在这种情况下，修改函数内的形式参数对实际参数没有影响。 |
| [指针调用](https://www.nowcoder.com/tutorial/10003/3e074044cfec4a039efc1a554436750c) | 该方法把参数的地址复制给形式参数。在函数内，该地址用于访问调用中要用到的实际参数。这意味着，修改形式参数会影响实际参数。 |
| [引用调用](https://www.nowcoder.com/tutorial/10003/3072d4e1d29046f69853255ac8433eea) | 该方法把参数的引用复制给形式参数。在函数内，该引用用于访问调用中要用到的实际参数。这意味着，修改形式参数会影响实际参数。 |
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569293564825_01DCB7AF3945BA0FD64A3927F2B69FB4)
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569293614367_3A8030D1E285F735B6AA55370958FD4E)
...
|                             概念                             |                           描述                           |
| :----------------------------------------------------------: | :------------------------------------------------------: |
| [把引用作为参数](https://www.nowcoder.com/tutorial/10003/1a7e077a8bff4d2e835029f6d65ab0a3) | C++ 支持把引用作为参数传给函数，这比传一般的参数更安全。 |
| [把引用作为返回值](https://www.nowcoder.com/tutorial/10003/c0d7ba0daea44c06a92e0a4100317390) |  可以从 C++ 函数中返回引用，就像返回其他数据类型一样。   |
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569295182896_91940D393D89B1DB5B92436620CA1BC8)
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569295301769_55EE7A857A03008353B246E1A70E991C)
...
有些信号不能被程序捕获，但是下表所列信号可以在程序中捕获，并可以基于信号采取适当的动作。这些信号是定义在 C++ 头文件 <csignal> 中。</csignal>
...
最后一个程序：pthread_join执行后main线程阻塞；threads[i]线程在pthread_join前已经创建运行，运行顺序与线程阻塞无关
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569295475596_9439AD18241F52B04FB30666FA8012B7)
...
![图片说明](https://uploadfiles.nowcoder.com/images/20190924/334190970_1569295493345_F7A6CB412ED7F2C38470A57736E51569)
